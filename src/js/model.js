...
// import { getJSON, sendJSON } from './helpers.js'; // replaced by AJAX function
...
export const loadRecpe = async function (id) {
  try {
...
export const getSearchResultsPage = function (page = state.search.page) {
  ...
  // calculating page dimensions to render
...
// function for clearing bookmarks from the local storage(for debugging)
